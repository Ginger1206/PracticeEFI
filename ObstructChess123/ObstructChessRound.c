  ...
  )
{
  ...
  Who                               = 0;
  //isRivalComputer                   = isSinglePlayer; //G
  BlackScore                        = 3;
  WhiteScore                        = 3;
  ...
  */ //G
  ...
  BmpFileToSolarImage (pGraph, INFO_BLOCK_01_IMAGE_FILENAME, &WhiteInfoBlock.Foreground, &BmpWidth, &BmpHeight); //G
  ...
  BmpFileToSolarImage (pGraph, INFO_BLOCK_01_IMAGE_FILENAME, &BlackInfoBlock.Foreground, &BmpWidth, &BmpHeight); //G
...
SingleRoundStart:
  ...
  EfiStrCpy ((CHAR16 *) &Player2Name,  L"COMPUTER" ); //G
  ...
  PrintString (pGraph, &BlackInfoBlock.Foreground, 20 ,  20 ,  SOLAR_BLACK , Player1Name); //G
  //PrintString (pGraph, &WhiteInfoBlock.Foreground, (isSinglePlayer) ? 20 : 70, (isSinglePlayer) ? 20 : 11, SOLAR_BLACK, Player2Name);
  PrintString (pGraph, &WhiteInfoBlock.Foreground,  20 ,  20 , SOLAR_BLACK, Player2Name); //G
